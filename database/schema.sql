...
/* LOAD DATA LOCAL INFILE 'CSV Files/Patient.csv' INTO TABLE Patient FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\r\n' IGNORE 1 ROWS; */
/* LOAD DATA LOCAL INFILE 'CSV Files/Visit.csv' INTO TABLE Visit FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\r\n' IGNORE 1 ROWS; */
/* LOAD DATA LOCAL INFILE 'CSV Files/Doctor.csv' INTO TABLE Doctor FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\r\n' IGNORE 1 ROWS; */
/* LOAD DATA LOCAL INFILE 'CSV Files/Prescription.csv' INTO TABLE Prescription FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\r\n' IGNORE 1 ROWS; */
/* LOAD DATA LOCAL INFILE 'CSV Files/New_Drug.csv' INTO TABLE Drug FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\r\n' IGNORE 1 ROWS; */