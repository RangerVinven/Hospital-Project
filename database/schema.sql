...
CREATE TABLE Patient(patientID varchar(10) primary key, firstname varchar(20), surname varchar(30), postcode varchar(8), address varchar(50), phone varchar(12), email varchar(40), insuranceID varchar(10), insuranceType varchar(20), insuranceDuration int);
